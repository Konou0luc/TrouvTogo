...
export default function MessagesPage() {
  return (
    <div className="bg-white min-h-[calc(100vh-64px)] flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-1 items-center justify-center bg-neutral-50/50">
        <div className="text-center">
          <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl border border-neutral-200 bg-white text-neutral-200">
